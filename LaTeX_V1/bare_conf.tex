...
\begin{figure}[b]
	\includegraphics[width=9.5cm]{pdf/Architecture_V3.pdf}
...
\begin{figure}[!t]\centering
	\includegraphics[width=7cm]{pdf/VirtualGrid.pdf}
