...
%~\cite{DBLP:journals/pvldb/ZhangWYGLZ15,7498315,DBLP:conf/icde/ChenDS17,DBLP:conf/bigdataconf/LealGZY15}.
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\linewidth,height=5.7cm]{pdf/RangeTraverse_V7.pdf}
	\vspace{-.2in}
